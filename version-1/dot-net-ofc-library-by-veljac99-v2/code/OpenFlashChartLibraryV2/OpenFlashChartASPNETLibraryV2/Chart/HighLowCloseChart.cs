...
{
  /// <summary>
  /// HLC chart (High - Low - Close financial chart)
  /// </summary>
  public class HighLowCloseChart : ChartBase
  {
    // Fields
    private int _alpha;
    ...
    private HighLowCloseChartData _values;
    ...
    public HighLowCloseChart(int maxDecimals)
    {
      _maxDecimals = maxDecimals;
      this._values = new HighLowCloseChartData(maxDecimals);
    }
    ...
    public override string ChartId
    {
      get
      {
        return ChartBase.ChartType.hlc.ToString();
      }
    }
    ...
    [JsonIgnore]
    public HighLowCloseChartData Data
    {
      get { return _values == null ? new HighLowCloseChartData(_maxDecimals) : _values; }
      set { _values = value; }
    }
